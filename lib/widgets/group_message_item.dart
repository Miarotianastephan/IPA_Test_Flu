...
class GroupMessageItem extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GroupMessageItem> createState() => _GroupMessageItemState();
}

class _GroupMessageItemState extends ConsumerState<GroupMessageItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return VisibilityDetector(
      key: Key("grp_msg_${widget.message.hashCode}_${widget.messageId}"),
  ...
  Widget _buildEmojiWidget(String path, double width, double height) {
    ...
    if (isLocalFile && File(path).existsSync()) {
      return SvgPicture.file(File(path), width: width, height: height);
    } else {
