...
class _LikePageState extends ConsumerState<LikePage>
  ...
  void _fetchVideos() {
    ref
        .read(userVideoListProvider(UserVideoListType.like).notifier)
        .fetch(refresh: true);
  }

  void _loadMoreVideos() {
    final provider = userVideoListProvider(UserVideoListType.like);
  ...
  Widget build(BuildContext context) {
    ...
    final videoProvider = userVideoListProvider(UserVideoListType.like);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(translate("likes"), style: TextStyle(color: Colors.white)),
        bottom: TabBar(
